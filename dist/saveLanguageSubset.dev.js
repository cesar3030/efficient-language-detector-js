...
exports.saveLanguageSubset = void 0;
const isoLanguages_js_1 = require("./isoLanguages.js");
exports.saveLanguageSubset = (function () {
    /**
    ...
    function saveSubset(langArray, ngrams, defaultLanguages, type) {
        ...
        download('// Copyright 2023 Nito T.M. [ Apache 2.0 Licence https://www.apache.org/licenses/LICENSE-2.0 ]\n' +
            ...
            '   type: "' + type + '",\n' +
            '   languages: ' + JSON.stringify((0, isoLanguages_js_1.isoLanguages)(langArray, defaultLanguages)) + ',\n' +
            '   isSubset: true,\n' +
